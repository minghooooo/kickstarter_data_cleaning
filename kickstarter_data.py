    ...
    for filename in filenames:
        ...
        with open(file + i+'\\'+filename ,'r',encoding='utf-8') as f:
            ...
            for c2 in content2:
                ...
                pattern0 = re.compile('"country_displayable_name":"(.*?)","currency"',re.S)
